...
#input1 = open('train_matrix_pred.pkl', 'rb')
#matrix_pred = pkl.load(input1)
#input2 = open('train_line_pred.pkl', 'rb')
#pred = pkl.load(input2)
prev_time = time.clock()
#print(matrix_pred)
s = 0
matrix_pred = {}
pred = {}
for img in range(21, 42):
    case = SAMPLE[img]
    case1 = case[:2]
    case2 = case[3:]
...
output1 = open('train_matrix_pred21-42.pkl', 'wb')
pkl.dump(matrix_pred, output1)
output2 = open('train_line_pred21-42.pkl', 'wb')
