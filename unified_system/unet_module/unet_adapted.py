...
w = torch.Tensor([0.324, 1.052, 0.624])
w = w.cuda(2)
...
torch.save(net.Unetpure.state_dict(), "/home/yiqin/TumorSeg/unified_system/unet_module/u_net_pure_2cp032410520624.txt")
torch.save(net.state_dict(), "/home/yiqin/TumorSeg/unified_system/unet_module/u_net_2cp032410520624.txt" )
